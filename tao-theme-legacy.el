;;; tao-legacy-theme.el --- Tao of EMACS grayscale color theme
...
(defcustom tao-theme-scale-fn 'tao-theme-perceptual-scale
  "Function to generate 16 intensity values for the grayscale scale.
Recommended: `tao-theme-perceptual-scale` (perceptually uniform)."
  :type 'function
  :group 'tao-theme)
...
(defun tao-theme-scale-to-palette (scale)
  ...
  (tao-theme-colors-to-palette
   (if tao-theme-use-sepia
       (tao-theme-scale-to-colors-sepia scale)
     (tao-theme-scale-to-colors scale))))
...
(defun tao-apply-custom-theme (theme-name)
  (custom-theme-set-faces
   ...
   `(default                                          ((t (:foreground ,color-10 :background ,color-1))))
   `(italic                                           ((t (:italic t ))))
