...
(defun tao-apply-custom-theme (theme-name)
  (custom-theme-set-faces
   ...
   `(org-level-1                                      ((t (:foreground ,color-14 :height ,(tao-theme-height 1.7) ))))
   `(org-level-2                                      ((t (:foreground ,color-10 :height ,(tao-theme-height 1.5) ))))
   `(org-level-3                                      ((t (:foreground ,color-9 :height ,(tao-theme-height 1.3) ))))
   `(org-level-4                                      ((t (:foreground ,color-9 :height ,(tao-theme-height 1.1) ))))
   `(org-level-5                                      ((t (:foreground ,color-9 :height ,(tao-theme-height 1) ))))
   `(org-level-6                                      ((t (:foreground ,color-9 :height ,(tao-theme-height 1) ))))
   `(org-level-7                                      ((t (:foreground ,color-9 :height ,(tao-theme-height 1) ))))
   `(org-level-8                                      ((t (:foreground ,color-8 :height ,(tao-theme-height 1) ))))
