...
(defun tao-apply-custom-theme (theme-name)
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face                           ((t (:foreground ,color-8 :italic t :variable-pitch t :height ,(tao-theme-height 1.1) ))))
   ...
   `(font-lock-regexp-grouping-backslash              ((t (:foreground ,color-5 :weight bold))))
   ...
   `(outline-2                                        ((t ( :height ,(tao-theme-height 1.1) :italic t :inherit org-heading :underline t))))
   `(outline-3                                        ((t ( :height ,(tao-theme-height 1.1) :italic t :inherit org-heading))))
   `(outline-4                                        ((t ( :height ,(tao-theme-height 1.1) :italic t :inherit org-heading :underline t))))
