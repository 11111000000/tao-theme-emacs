...
(defun tao-apply-custom-theme (theme-name)
  (custom-theme-set-faces
   ...
   ;; font lock
   `(font-lock-builtin-face                           ((t (:foreground ,color-14 :weight normal  ))))
   `(font-lock-keyword-face                           ((t (:foreground ,color-12 :weight normal :italic t ))))
   ...
   `(font-lock-function-name-face                     ((t (:foreground ,color-14))))
   ...
   `(font-lock-variable-name-face                     ((t (:foreground ,color-10 ))))
   ...
   `(helm-swoop-target-word-face                      ((t (:foreground ,color-13 :background ,color-7))))
   ...
   `(org-checkbox                                     ((t (:foreground ,color-11 :box (:line-width 2 :style pressed-button) :height ,(tao-theme-height 0.8) :inherit fixed-pitch))))
   `(org-checkbox-statistics-todo                    ((t (:foreground ,color-11 :box (:line-width 2 :style pressed-button) :bold t))))   
   ...
   `(org-level-1                                      ((t ( :height ,(tao-theme-height 1.8) :inherit org-heading))))
   `(org-level-2                                      ((t ( :height ,(tao-theme-height 1.4) :inherit org-heading ))))
   `(org-level-3                                      ((t ( :height ,(tao-theme-height 1.3) :inherit org-heading))))
   `(org-level-4                                      ((t ( :height ,(tao-theme-height 1.2) :inherit org-heading))))
   ...
   `(org-meta-line                                    ((t (:foreground ,color-7 :height ,(tao-theme-height 0.8) :inherit fixed-pitch))))
   ...
   `(markdown-url-face                                ((t (:underline t :foreground ,color-12 :inherit fixed-pitch))))
