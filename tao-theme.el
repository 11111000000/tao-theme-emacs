...
(defun tao-apply-theme-faces (theme-name palette)
  ...
  (let* ((class '((class color)
                  (min-colors 89)))
         (class-tty '((class color)
                      (min-colors 16)
                      (type tty)))
         (class-tty-8 '((class color)
                        (min-colors 8)
                        (type tty)))
         (p palette))
    (custom-theme-set-faces
     theme-name
     ;; Base DRY faces
     `(tao-bg                      ((,class (:background ,(tao :color-1)))
                                    (,class-tty (:background "black"))
                                    (,class-tty-8 (:background "black"))))
     `(tao-bg-alt                  ((,class (:background ,(tao :color-2)))
                                    (,class-tty (:background "black"))
                                    (,class-tty-8 (:background "black"))))
     `(tao-base                    ((,class (:foreground ,(tao :color-9)))
                                    (,class-tty (:foreground "white"))
                                    (,class-tty-8 (:foreground "white"))))
     `(tao-muted                   ((,class (:foreground ,(tao :color-7)))
                                    (,class-tty (:foreground "brightblack"))
                                    (,class-tty-8 (:foreground "black" :weight bold))))
     `(tao-faint                   ((,class (:foreground ,(tao :color-6)))
                                    (,class-tty (:foreground "brightblack"))
                                    (,class-tty-8 (:foreground "black" :weight bold))))
     `(tao-active                  ((,class (:foreground ,(tao :color-10)))
                                    (,class-tty (:foreground "brightwhite"))
                                    (,class-tty-8 (:foreground "white" :weight bold))))
     `(tao-accent                  ((,class (:foreground ,(tao :color-11)))
                                    (,class-tty (:foreground "brightwhite" :weight bold))
                                    (,class-tty-8 (:foreground "white" :weight bold))))
     `(tao-strong                  ((,class (:foreground ,(tao :color-10) :weight bold))
                                    (,class-tty (:foreground "brightwhite" :weight bold))
                                    (,class-tty-8 (:foreground "white" :weight bold))))
     ...
     `(tao-warning                 ((,class (:foreground ,(tao :color-7) :weight bold))
                                    (,class-tty (:foreground "brightyellow" :weight bold))
                                    (,class-tty-8 (:foreground "yellow" :weight bold))))
     `(tao-success                 ((,class (:foreground ,(tao :color-9) :bold t))
                                    (,class-tty (:foreground "brightgreen" :weight bold))
                                    (,class-tty-8 (:foreground "green" :weight bold))))
     `(tao-link                    ((,class (:foreground ,(tao :color-9) :underline t))
                                    (,class-tty (:foreground "brightcyan" :underline t))
                                    (,class-tty-8 (:foreground "cyan" :underline t))))
     ;; Core faces, editor chrome
     `(default                     ((,class (:background ,(tao :color-1) :foreground ,(tao :color-10)))
                                    (,class-tty (:background "black" :foreground "white"))
                                    (,class-tty-8 (:background "black" :foreground "white"))))
     `(fringe                      ((,class (:inherit tao-bg))
                                    (,class-tty (:background "black"))
                                    (,class-tty-8 (:background "black"))))
     ...
     `(minibuffer-prompt           ((,class (:inherit tao-accent :weight bold))
                                    (,class-tty (:foreground "brightcyan" :weight bold))
                                    (,class-tty-8 (:foreground "cyan" :weight bold))))
     `(region                      ((,class (:background ,(tao :color-4)))
                                    (,class-tty (:background "brightblue"))
                                    (,class-tty-8 (:background "blue"))))
     `(secondary-selection         ((,class (:background ,(tao :color-4)))
                                    (,class-tty (:background "brightblack"))
                                    (,class-tty-8 (:background "black" :weight bold))))
     `(highlight                   ((,class (:background ,(tao :color-5)))
                                    (,class-tty (:background "brightblue" :foreground "black"))
                                    (,class-tty-8 (:background "blue" :foreground "white"))))
     `(vertical-border             ((,class (:foreground ,(tao :color-6)))
                                    (,class-tty (:foreground "brightblack"))
                                    (,class-tty-8 (:foreground "black" :weight bold))))
     `(cursor                      ((,class (:background ,(tao :color-8)))
                                    (,class-tty (:background "brightwhite" :foreground "black"))
                                    (,class-tty-8 (:background "white" :foreground "black"))))
     ...
     `(font-lock-builtin-face           ((,class (:inherit tao-active))
                                         (,class-tty (:foreground "brightmagenta"))
                                         (,class-tty-8 (:foreground "magenta"))))
     `(font-lock-comment-face           ((,class (:inherit tao-muted :slant italic))
                                         (,class-tty (:foreground "brightblack" :slant italic))
                                         (,class-tty-8 (:foreground "black" :weight bold))))
     `(font-lock-comment-delimiter-face ((,class (:inherit font-lock-comment-face))
                                         (,class-tty (:inherit font-lock-comment-face))
                                         (,class-tty-8 (:inherit font-lock-comment-face))))
     `(font-lock-constant-face          ((,class (:inherit tao-accent))
                                         (,class-tty (:foreground "brightcyan"))
                                         (,class-tty-8 (:foreground "cyan"))))
     `(font-lock-doc-face               ((,class (:inherit tao-muted :slant italic))
                                         (,class-tty (:foreground "brightblack" :slant italic))
                                         (,class-tty-8 (:foreground "black" :weight bold :slant italic))))
     `(font-lock-function-name-face     ((,class (:inherit tao-accent))
                                         (,class-tty (:foreground "brightblue" :weight bold))
                                         (,class-tty-8 (:foreground "blue" :weight bold))))
     `(font-lock-keyword-face           ((,class (:inherit tao-strong))
                                         (,class-tty (:foreground "brightyellow" :weight bold))
                                         (,class-tty-8 (:foreground "yellow" :weight bold))))
     `(font-lock-string-face            ((,class (:inherit tao-success :slant italic))
                                         (,class-tty (:foreground "brightgreen" :slant italic))
                                         (,class-tty-8 (:foreground "green" :slant italic))))
     `(font-lock-type-face              ((,class (:inherit tao-faint))
                                         (,class-tty (:foreground "brightblack"))
                                         (,class-tty-8 (:foreground "black" :weight bold))))
