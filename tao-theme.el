...
(defun tao-apply-theme-faces (theme-name palette)
  ...
  (let* ((class '((class color)
    ...
    (custom-theme-set-faces
     ...
     `(tao-base       ((t (:foreground ,(tao :color-11)))))
     ...
     ;; DIRED/Dired+
     `(dired-directory         ((t (:inherit tao-accent
                                         :weight bold))))
     ...
     `(diredp-dir-name         ((t (:inherit tao-base
                                         :weight bold))))
     ...
     `(company-tooltip-selection ((t (:inherit tao-strong))))
     ...
     `(corfu-current ((t (:inherit company-tooltip-selection))))
     `(corfu-candidate-overlay-face ((t (:inherit tao-accent))))
     ...
     `(gnus-group-news-1-empty ((t (:inherit tao-base
                                         :weight bold))))
     ...
     `(gnus-signature          ((t (:inherit tao-faint
                                         :slant italic))))
     ...
     `(message-mml             ((t (:inherit tao-muted
                                         :slant italic))))
     `(message-separator       ((t (:inherit tao-faint))))
     `(message-cited-text      ((t (:inherit tao-muted
                                         :slant italic))))
     ...
     `(ansi-color-names-vector [, (tao :color-0)
                                  ...
                                  , (tao :color-9)])
     ;; Misc/proxies (suite)
     `(widget-field ((t (:background ,(tao :color-3)))))
     `(hl-line ((t (:background ,(tao :color-4) :extend t))))
